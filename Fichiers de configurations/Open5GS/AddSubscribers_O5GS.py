...
current_imsi = int(last_document.get('imsi', '001010000000000'))

# Insere xxx entrées en incrementant le n° "imsi" de 1
for i in range(499): #nombre de subscribers à ajouter à la base d'abonnés
    current_imsi += 1
    base_data = {
